...
redis_client = RedisClient.new(host: "localhost", port: RedisServerHelper::REAL_TCP_PORT, driver: driver)
redis = Redis.new(host: "localhost", port: RedisServerHelper::REAL_TCP_PORT, driver: driver)
